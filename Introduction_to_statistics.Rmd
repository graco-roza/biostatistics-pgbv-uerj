...
Generally we will want to write codes that are longer than a couple of lines. We want this (yes, ***you want it too!***) because we believe we will repeat the same steps many many times (**rountinely**) that would be boring to write it all over again always when we need it .
